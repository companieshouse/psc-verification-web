...
export const env = readEnv(process.env, {
    ...
    OTEL_LOG_ENABLED: bool.describe("Flag to enable OpenTelemetry logging"),
    ...
    PSC_VERIFICATION_WEB_PORT: port.describe("Port number the PSC Verification web server listens on"),
